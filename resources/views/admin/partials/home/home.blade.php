    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                    <div class="au-card-title"
                        style="background-image:url('admin/images/bg-title-01.jpg');">
            ...
            <div class="col-lg-6">
                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                    <div class="au-card-title"
                        style="background-image:url('admin/images/bg-title-02.jpg');">
                        <div class="bg-overlay bg-overlay--blue"></div>
                        <h3>
...
@section('script')
    <script>
        var mon = {!! json_encode($months) !!};
        var pCount = {!! json_encode($productCount) !!};
    </script>
