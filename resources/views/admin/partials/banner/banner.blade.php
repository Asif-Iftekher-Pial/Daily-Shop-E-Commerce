    ...
    <div class="col-md-12" style="padding-left: 45px;padding-right:45px">
        <div class="overview-wrap">
            ...
            <button type="button" class="btn btn-secondary mb-1" data-toggle="modal" data-target="#mediumModal">
                <i class="zmdi zmdi-plus"></i> New Banner
            </button>
                ...
                <div class="modal-dialog modal-lg" role="document" style="max-width: 1000px">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="mediumModalLabel">New Banner</h5>
                        ...
                        <table class="table table-hover" id="refresh">
                            ...
                            <tbody>
                                @if (count($data) > 0)
                                    @foreach ($data as $key => $item)
                                        <tr>
                                            ...
                                            <td><img style="width: 200px"
                                                    src="{{ asset('admin/images/banner/' . $item->image) }}" alt=""
                                                    srcset=""></td>
                                            <td>{{ $item->title }}</td>
                                            <td>{{ $item->summary }}</td>
                                            <td>
                                    ...
                                    @endforeach
                                @else
                                    <p class="text-danger py-1">No banner found</p>
                                @endif
                            </tbody>
                        </table>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit', '#insert', function(e) {
                ...
                $.ajax({
                    type: "post",
                    url: "{{ route('banner-management.store') }}",
        ...
        $(document).on('click', '.editButton', function(e) {
            ...
            // alert(id);
            var url = "{{ route('banner-management.edit', ':id') }}"
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#previous_image').html(
                        '<img src="{{ asset('admin/images/banner/') }}' + '/' +
        ...
        $(document).on('submit', '#update', function(e) {
            ...
            var url = "{{ route('banner-management.update', ':id') }}"
            url = url.replace(':id', id);
            // console.log(url);
        ...
        $(document).on('click', '.deleteButton', function(e) {
            ...
            // alert('ok')
            var id = $(this).attr('href');
            var url = "{{ route('banner-management.destroy', ':id') }}"
            url = url.replace(':id', id);
