                    ...
                    <form id="insert" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input name="cat_name" type="text" class="form-control" aria-required="true" aria-invalid="false">
                            </div>
            ...
            <form id="update" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input id="cat_id" name="cat_id" type="hidden" class="form-control" aria-required="true" aria-invalid="false">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Cancel</button>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click','.editButton',function (e) { 
                ...
                // alert(id);
                var url = "{{ route('category-management.edit',":id") }}"
            ...
            $(document).on('submit','#update',function (e) { 
                ...
                // alert('ok')
                var id = $('#cat_id').val();
                var url = "{{ route('category-management.update',":id") }}"
                url = url.replace(':id',id);
