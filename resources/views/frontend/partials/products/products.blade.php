                                ...
                                @foreach ($products as $product)
                                    @foreach ($product->getProducts as $item)
                                        <li>
                                            ...
                                            <!-- product badge -->
                                            <span class="aa-badge {{ $item->conditions == 'hot' ? 'hot' : 'sale' }}">{{ ucfirst( $item->conditions) }}!</span>
                                        </li>
                                    @endforeach
                                @endforeach
                            </ul>
                                                        ...
                                                        <div class="simpleLens-gallery-container" id="demo">
                                                            <div class="simpleLens-container">
                                                                <div class="simpleLens-big-image-container">
                                                                    <a class="simpleLens-lens-image" data-lens-image=""><img
                                                                            src="" class="simpleLens-big-image">
                                                                    </a>
                                                                </div>
                                                            </div>
